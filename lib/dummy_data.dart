...
List<Hotel> dummyHotels = [
  Hotel(
      ...
      price: '1,882 EGP',
      rating: 'Very Good',
      numRating: '1,048 Ratings', category: ["c1"]),
  Hotel(
      id: "h2",
      title: "Sky View Suites Hotel",
  ...
  Hotel(
      ...
      price: '685 EGP',
      rating: 'Excellent',
      numRating: '2,777 Ratings', category: ["c2"]),
  Hotel(
      id: "h4",
      title: "Coral Sea Aqua Club",
  ...
  Hotel(
      ...
      price: '5,570 EGP',
      rating: 'Very Good',
      numRating: '440 Ratings', category: ["c3"]),
  Hotel(
      id: "h6",
      title: 'Rixos Alamein',
  ...
  Hotel(
      ...
      price: '4,212 EGP',
      rating: 'Very Good',
      numRating: '881 Ratings', category: ["c4"]),
  Hotel(
      id: "h8",
      title: 'Porto El Jabal Hotel',
      imgUrl: 'assets/4.png',
  ...
  Hotel(
      ...
      price: '2,555 EGP',
      rating: 'Excellent',
      numRating: '2,048 Ratings', category: ["c5"]),
  Hotel(
      id: "h10",
      title: 'Tolip Hotel Alexandria',
      imgUrl: 'assets/6.png',
  ...
  Hotel(
      ...
      price: '495 EGP',
      rating: 'Very Good',
      numRating: '254 Ratings', category: ["c6"]),
  Hotel(
      id: "h12",
      title: 'Royal Crown Hotel',
      imgUrl: 'assets/8.png',
